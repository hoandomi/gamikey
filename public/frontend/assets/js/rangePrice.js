  ...
  $("#sliderrange").each(function (e) {
    ...
    slider.slider({
      ...
      slide(event, ui) {
        ...
        // ? Gán value-0 vào thẻ input có id start
        $("#startRangePrice").val(slider.slider("values", 0));
        // ? Gán value-1 vào thẻ input có id end
        $("#endRangePrice").val(slider.slider("values", 1));
        $(slider.data("value-1")).html(
