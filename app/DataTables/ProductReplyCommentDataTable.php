...
class ProductReplyCommentDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '
                <a title="Xóa Sản Phẩm" data-id="' . $query->id . '" href="' . route('admin.reply-comment.destroy', $query->id) . '" class="btn btn-danger-gradient btn-wave waves-effect waves-light deleteBtn"><i class="fas fa-trash"></i></a>
                ';
            })
     ...
     */
    public function query(ProductReplyComment $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('productreplycomment-table')
    ...
    {
        return 'ProductReplyComment_' . date('YmdHis');
    }
}
