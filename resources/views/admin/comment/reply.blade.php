        ...
        <div class="main-content app-content">
            <div class="container-fluid"> <!-- PAGE-HEADER -->
                <div class="page-header">
                    <h1 class="page-title my-auto">Tất Cả Trả Lời Bình Luận</h1>
                    <div>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"> <a href="javascript:void(0)">Ecommerce</a> </li>
                            <li class="breadcrumb-item active" aria-current="page">Tất Cả Trả Lời Bình Luận</li>
                        </ol>
                    </div>
            ...
            $(document).ready(function() {
                ...
                $('body').on('click', '.toggleswitchStatus', function() {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.reply-comment.change-status') }}",
