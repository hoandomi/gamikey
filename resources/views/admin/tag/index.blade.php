        ...
        <div class="main-content app-content">
            <div class="container-fluid"> <!-- PAGE-HEADER -->
                <div class="page-header">
                    <h1 class="page-title my-auto">Nhãn</h1>
                    <div>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"> <a href="javascript:void(0)">Ecommerce</a> </li>
                            <li class="breadcrumb-item active" aria-current="page">Nhãn</li>
                        </ol>
                    </div>
                </div> <!-- PAGE-HEADER END --> <!-- Start::row-1 -->
                <div class="page-header d-flex justify-content-end">
                    <a href="{{ route('admin.tag.create') }}" class="btn btn-primary btn-wave waves-effect waves-light">Thêm
                        Mới</a>
                </div>
                <div class="row mt-3">
                    <div class="col-xl-12">
