    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title my-auto">Sửa Danh Mục: <strong>{{ $subCategory->name }}</strong></h1>
                <div>
                                                    ...
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="product-description-add" class="form-label">Mô Tả
                                                                Danh
                                                                Mục</label>
                                                            <textarea class="form-control" id="product-description-add" rows="2" name="description">{{ $subCategory->description }}</textarea>
