    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title my-auto">Thêm Danh Mục Phụ</h1>
                <div>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)">Ecommerce</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Thêm Danh Mục Phụ</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                                                    ...
                                                    <div class="row gy-3">
                                                        ...
                                                        <div class="col-xl-12">
                                                            ...
                                                            <input type="text" class="form-control" id="product-name-add"
                                                                placeholder="Tên Danh Mục Phụ" name="name"
                                                                value="{{ old('name') }}">
